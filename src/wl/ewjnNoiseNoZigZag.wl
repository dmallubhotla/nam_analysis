...
T1EzzNamCustomScaleNZZ[zSI_?NumericQ
	...
	, constants_?AssociationQ /; AllTrue[requiredConstants, KeyExistsQ[constants, #] &]
	, scale_?NumericQ
] := T1EzzNamINTERNALCustomScale[zSI
	, qCutoffSI
	, parameters["omegaSI"], parameters["omegaPSI"], parameters["tauSI"], parameters["vFSI"], parameters["TRel"], parameters["TcSI"], parameters["dipoleMomentSI"]
	, constants["epsilon0SI"], constants["hbarSI"], constants["cLightSI"]
	, scale
...
T1EzzNamINTERNALCustomScale[zSI_?NumericQ
	, qCutoffSI_?NumericQ
	, omegaSI_?NumericQ
	, omegaPSI_?NumericQ
	, tauSI_?NumericQ
	...
	chiSI = chiZZEUnitLessNamCustomScale[zSI, qCutoffSI * cLightSI / omegaSI, omegaSI, omegaPSI^2 * tauSI / (4 * Pi), tauSI, vFSI, TRel * TcSI, TcSI, omegaPSI, cLightSI, scale]
},
	((hbarSI * epsilon0SI * cLightSI^3) / (dipoleMomentSI^2 * omegaSI^3)) * (1/(chiSI * Coth[omegaSI/(2 * TRel * TcSI)]))
];

chiZZEUnitLessNamCustomScale[z_?NumericQ, ufCutoff_?NumericQ, omega_?NumericQ, sigmaN_?NumericQ, tau_?NumericQ, vf_?NumericQ, temp_?NumericQ, Tc_?NumericQ, omegap_?NumericQ, cLight_?NumericQ, scale_?NumericQ] := With[
	{
		imrpNInterp = getImrpNI[ufCutoff, namDielectricFunctionCoefficientsCustomScale[omega, sigmaN, tau, vf, temp, Tc, scale]],
		imrpLInterp = getImrpLI[omega, vf, omegap, tau, cLight]
	},
		NIntegrate[
			u^2 * Min[imrpNInterp[u], imrpLInterp[u]] * E^(-2 * u * z)
