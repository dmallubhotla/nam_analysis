...
$(USED_CALC_HIGH_TEMP_NAM): $(CALC_DIR)/%.csv: $(SCRIPT_DIR)/%Calc.wls $(MATHEMATICA_INSTALLS) | $(CALC_DIR)
	$(WS) $<

$(USED_FIGS_HIGH_TEMP_NAM): $(FIG_DIR)/%.jpg: $(SCRIPT_DIR)/%Plot.wls $(CALC_DIR)/%.csv ewjnnoiseInstall | $(FIG_DIR)
	$(WS) $<
