...
$(FIG_DIR)/ConductivityZone3Real.jpg: $(SCRIPT_DIR)/ConductivityZone3SmallKVsFullPlots.wls $(CALC_DIR)/ConductivityZone3AsymptoticForm.csv $(CALC_DIR)/ConductivityZone3Normal.csv $(CALC_DIR)/ConductivityZone3AsymptoticHighForm.csv $(MATHEMATICA_INSTALLS) | $(FIG_DIR)
	$(WS) $(SCRIPT_DIR)/ConductivityZone3SmallKVsFullPlots.wls

$(FIG_DIR)/ConductivityZone3Imag.jpg: $(SCRIPT_DIR)/ConductivityZone3SmallKVsFullImagPlots.wls $(CALC_DIR)/ConductivityZone3AsymptoticForm.csv $(CALC_DIR)/ConductivityZone3Normal.csv $(CALC_DIR)/ConductivityZone3AsymptoticHighForm.csv $(MATHEMATICA_INSTALLS) | $(FIG_DIR)
...
$(FIG_DIR)/SampleElectricNoiseFresnelPerfectConductor.jpg: $(SCRIPT_DIR)/SampleElectricNoiseFresnelPerfectConductor.wls $(MATHEMATICA_INSTALLS) | $(FIG_DIR)
	$(WS) $(SCRIPT_DIR)/SampleElectricNoiseFresnelPerfectConductor.wls

$(FIG_DIR)/SampleElectricNoiseZetaPerfectConductor.jpg: $(SCRIPT_DIR)/SampleElectricNoiseZetaPerfectConductor.wls $(MATHEMATICA_INSTALLS) | $(FIG_DIR)
