...
\begin{document}
	...
	Some typical values for the conductivity calculation for a gigahertz device near lead look like $\sigma_N = 10^{16}$, $\xi = .0073$, $\nu = 730$ and $\kappa ~ .0005$.

	\begin{figure}[htp]
		\centering
		\includegraphics[width=14cm]{ConductivityZone3Real}
		\caption{TODO} \label{fig:ConductivityRe}
	\end{figure}

	\begin{figure}[htp]
		\centering
		\includegraphics[width=14cm]{ConductivityZone3Imag}
		\caption{TODO INSERT DESCRIPTION} \label{fig:ConductivityIm}
	\end{figure}
