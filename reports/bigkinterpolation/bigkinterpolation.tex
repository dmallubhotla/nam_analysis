...
\begin{document}
	...
	This is all well below the Fermi wave vector, which in these units is on the order of $u_F \sim 10^{15}$. \todo{pick a better name than $u_F$, no reason in SCs to be related to $k_F$}
	...
	\begin{figure}[htp]
		\centering
		\includegraphics[width=14cm]{imrp2}
	...
	\begin{figure}[htp]
		\centering
		\includegraphics[width=14cm]{chiZEsmallboi}
	...
	We do see in \fref{fig:chiZRange} that the $\flatfrac{1}{z^3}$ dependence goes to a constant value for $z \lesssim \frac{1}{u_F}$.
