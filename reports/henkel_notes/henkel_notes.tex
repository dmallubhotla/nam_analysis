...
\begin{document}
	...
	To get a sense of what this looks like, \fref{fig:SampleElectricNoiseFresnelPerfect} shows $g_{\parallel}(\lambda)$, comparing values for good conductors (with large imaginary part of $\epsilon$).
